...
const Card = ({ character }: Props) => {
  ...
  //#FBF976 morty shirt
  return (
    <div className="bg-white h-full hover:bg-green-800 shadow-xl hover:shadow-none cursor-pointer w-80 rounded-3xl flex flex-col items-center justify-center transition-all duration-500 ease-in-out">
